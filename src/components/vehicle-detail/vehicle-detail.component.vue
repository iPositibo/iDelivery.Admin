<template v-slot:top>
    <v-app id="inspire">
        ...
        <VehicleDetailTable :tableHeaders="headers" :vehicleDetailTable="tableData"></VehicleDetailTable>
...
<script>
    ...
    import VehicleDetailTable from '../vehicle-detail/vehicle-detail-table'

    export default {
        name: "VehicleDetailComponent",
        components: {
            VehicleDetailTable
        },
        data: () => ({
