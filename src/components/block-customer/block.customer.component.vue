<template v-slot:top>
    <v-app id="inspire">
        ...
        <BlockCustomerTable :tableHeaders="headers" :blockCustomerTable="tableData"></BlockCustomerTable>
...
<script>
    ...
    import BlockCustomerTable from './block-customer-table'

    export default {
        name: "BlockCustomersComponent",
        components: {
            BlockCustomerTable,
        },
        data: () => ({
