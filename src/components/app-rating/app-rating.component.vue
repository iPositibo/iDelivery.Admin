<template v-slot:top>
    <v-app id="inspire">
        ...
        <AppRatingTable :tableHeaders="headers" :AppRatingTable="tableData"></AppRatingTable>
...
<script>
    import AppRatingTable from '../app-rating/app-rating-table'
    import AppRatingService from '../app-rating/app-rating.service'
