<template v-slot:top>
    <v-app id="inspire">
        ...
        <RiderRatingTable :tableHeaders="headers" :riderRatingTable="tableData"></RiderRatingTable>
...
<script>
    ...
    import RiderRatingTable from '../rider-rating/rider-rating-table'

    export default {
        name: "RiderRatingsComponent",
        components: {
            RiderRatingTable
        },
        data: () => ({
