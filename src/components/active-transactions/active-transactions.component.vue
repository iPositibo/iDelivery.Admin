<template v-slot:top>
    <v-app id="inspire">
        ...
        <ActiveTransactionTable :tableHeaders="headers" :activeTransactionTable="tableData">
...
<script>
    import ActiveTransactionService from '../active-transactions/active-transactions.service'
    import ActiveTransactionTable from '../active-transactions/active-transactions-table'

    export default {
        name: "ActiveTransactionsComponent",
        components: {
            ActiveTransactionTable,
        },
        data: () => ({
        ...
        created() {
            ...
            ActiveTransactionService.getAllActiveTransactions()
                .then(response => {
