<template v-slot:top>
    <v-app id="inspire">
        ...
        <WalletLogTable :tableHeaders="headers" :walletLogTable="tableData"></WalletLogTable>
...
<script>
    import WalletLogService from '../wallet-log/wallet-log.service'
    import WalletLogTable from '../wallet-log/wallet-log-table'

    export default {
        name: "WalletLogsComponent",
        components: {
            WalletLogTable
        },
        data: () => ({
        ...
        created() {
            ...
            WalletLogService.getAllWalletLogs()
                .then(response => {
