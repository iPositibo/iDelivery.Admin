<template v-slot:top>
    <v-app id="inspire">
        ...
        <RiderStatusTable :tableHeaders="headers" :riderStatusTable="tableData"></RiderStatusTable>
...
<script>
    ...
    import RiderStatusTable from '../rider-status/rider-status-table'

    export default {
        name: "RiderStatusComponent",
        components: {
            RiderStatusTable,
        },
        data: () => ({
