<template v-slot:top>
    <v-app id="inspire">
        ...
        <BookingStatusTable :tableHeaders="headers" :bookingStatusTable="tableData"></BookingStatusTable>
...
<script>
    ...
    import BookingStatusTable from '../booking-status/booking-status-table'

    export default {
        name: "BookingStatusComponent",
        components: {
            BookingStatusTable
        },
        data: () => ({
