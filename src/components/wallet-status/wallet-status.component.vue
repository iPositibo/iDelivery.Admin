<template v-slot:top>
    <v-app id="inspire">
        ...
        <WalletStatusTable :tableHeaders="headers" :walletStatusTable="tableData"></WalletStatusTable>
...
<script>
    import WalletStatusService from '../wallet-status/wallet-status.service'
    import WalletStatusTable from '../wallet-status/wallet-status-table'
