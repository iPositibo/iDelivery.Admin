<template v-slot:top>
    <v-app id="inspire">
        ...
        <FareTable :tableHeaders="headers" :faresTable="tableData"></FareTable>
...
<script>
    import FaresService from '../fare/fares.service'
    import FareTable from '../fare/fares-table'
    ...
    export default {
        ...
        created() {
            ...
            this.headers = [{
                        ...
                        {
                            text: 'Total Base Kilometers',
                            value: 'totalBaseKilometers',
                            sortable: false
                        },
                        {
                            text: 'Surcharge',
                        ...
                        {
                            text: 'Riders Percentage',
                            value: 'ridersPercentage',
                            sortable: false
                        },
                        {
                            text: 'Company Percentage',
